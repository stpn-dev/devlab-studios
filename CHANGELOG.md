...
- `/services` keeps its route and gains the label "Solutions". Renaming the path would have needed a redirect and reset that page's accumulated search signals for no gain a label change does not already deliver.
